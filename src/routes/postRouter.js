...
postRouter.post("/", authMiddleware, uploadSingle.single('postImg'),postcreate);
postRouter.get("/:postid", postfind);
postRouter.patch("/postupdate/:postid", authMiddleware, uploadSingle.single('postImg'), postupdate);
